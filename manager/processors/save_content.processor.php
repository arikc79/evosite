...
$isfolder = (int)($_POST['isfolder'] ?? 0);
$richtext = (int)($_POST['richtext'] ?? 0);
...
$searchable = (int)($_POST['searchable'] ?? 0);
$cacheable = (int)($_POST['cacheable'] ?? 0);
...
$contentType = $_POST['contentType'] ?? 'document';
$contentdispo = (int)($_POST['content_dispo'] ?? 0);
$longtitle = $_POST['longtitle'] ?? '';
$hide_from_tree = (int)($_POST['hide_from_tree'] ?? 0);
$menutitle = $_POST['menutitle'] ?? '';
$hidemenu = (int)($_POST['hidemenu'] ?? 0);
$aliasvisible = (int)($_POST['alias_visible'] ?? 1);
